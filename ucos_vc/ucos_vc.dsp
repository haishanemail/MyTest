...
# ADD CPP /nologo /ML /W3 /Gm /GX /ZI /I "UCOS/CPU" /I "UCOS/SOURCE" /I "PC" /I "UCOS/CONFIG" /I "FS/API" /I "FS/CLIB" /I "FS/CONFIG/WIN32" /I "FS/DEVICE/RAM" /I "FS/FSL/FAT" /I "FS/LBL" /I "FS/OS" /I "UCOS/shell" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /FR /YX /FD /GZ /c
